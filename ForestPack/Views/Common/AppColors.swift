...
extension Color {
    static let forestGreen = Color(red: 0.133, green: 0.333, blue: 0.180)
    static let lightGreen = Color(red: 0.859, green: 0.922, blue: 0.847)
    static let darkGreen = Color(red: 0.110, green: 0.255, blue: 0.141)
    static let brown = Color(red: 0.545, green: 0.345, blue: 0.239)
    static let woodBrown = Color(red: 0.443, green: 0.302, blue: 0.212)
    static let yellowAccent = Color(red: 1.0, green: 0.843, blue: 0.0)
